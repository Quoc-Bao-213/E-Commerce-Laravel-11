                                        ...
                                        <li class="list-item">
                                            <span class="menu-link py-1">
                                                <input type="checkbox" name="categories" value="{{ $category->id }}"
                                                    class="chk-category" @if (in_array($category->id, explode(',', $fCategories))) checked @endif>
                                                {{ $category->name }}
                                            </span>
                                        ...
                                        <li class="list-item">
                                            <span class="menu-link py-1">
                                                <input type="checkbox" name="brands" value="{{ $brand->id }}"
                                                    class="chk-brand" @if (in_array($brand->id, explode(',', $fBrands))) checked @endif>
                                                {{ $brand->name }}
                                            </span>
              ...
              "clickable": true
                ...
                <div class="d-flex justify-content-between mb-4 pb-md-2">
                    ...
                    <div
                        ...
                        <select class="shop-acs__select form-select w-auto border-0 py-0 order-1 order-md-0"
                            aria-label="Sort Items" name="total-number" name="orderby" id="orderby">
                            ...
                            <div class="product-card mb-3 mb-md-4 mb-xxl-5">
                                <div class="pc__img-wrapper">
                                    <div class="swiper-container background-img js-swiper-slider"
                                        ...
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <a
                                                    href="{{ route('shop.product.details', ['productSlug' => $product->slug]) }}">
                                                    <img loading="lazy"
                                ...
                                <div class="pc__info position-relative">
                                    ...
                                    <h6 class="pc__title"><a
                                            href="{{ route('shop.product.details', ['productSlug' => $product->slug]) }}">{{ $product->name }}</a>
                                    </h6>
