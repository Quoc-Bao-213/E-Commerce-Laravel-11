                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    @foreach (explode(',', $product->images) as $gImg)
                                        <div class="swiper-slide product-single__image-item"><img loading="lazy"
                                                class="h-auto" src="{{ asset('uploads/products/' . $gImg) }}" width="104"
                        ...
                        @foreach ($relatedProducts as $relatedProduct)
                            <div class="swiper-slide product-card">
                                <div class="pc__img-wrapper">
                                    <a
                                        href="{{ route('shop.product.details', ['productSlug' => $relatedProduct->slug]) }}">
                                        <img loading="lazy"
                                ...
                                <div class="pc__info position-relative">
                                    ...
                                    <h6 class="pc__title"><a
                                            href="{{ route('shop.product.details', ['productSlug' => $relatedProduct->slug]) }}">{{ $relatedProduct->name }}</a>
                                    </h6>
